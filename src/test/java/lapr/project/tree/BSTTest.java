...
/**
    ...
    void findTest() {
        ...
        assertNotNull(instance.find(7));
        assertNotNull(instance.find(50));
        assertNotNull(instance.find(30));
        assertNull(instance.find(0,null));
    }
...
/**
    ...
    public void testInOrder() {
        ...
        assertEquals(bst.inOrder(), snapshot);
    }
/**
...
/**
    ...
    public void toStringTest() {
        ...
        assertEquals(instance.toString(), bst.toString());
        assertNotEquals(instance.toString(), bst2.toString());
    }
